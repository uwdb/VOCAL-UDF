...
if __name__ == "__main__":
    ...
    if dataset == "clevr":
        ...
        from visprog.prompts.vaw import create_prompt
    ...
    if dataset == "clevrer":
        input_vids = list(range(10000))
    elif dataset == "clevr":
        input_vids = list(range(15000))
    elif dataset == "charades":
        input_vids = list(range(9601))
    elif dataset == "vaw":
    ...
    for retry in range(3):
        ...
        try:
            for vid in tqdm(input_vids):
                ...
                if result == "yes":
                    pred_positive_images.append(vid)
            logger.info(pred_positive_images)
            break
    ...
    logger.info(f"pred_positive_images: {pred_positive_images}")
    y_pred = [1 if vid in pred_positive_images else 0 for vid in input_vids]
