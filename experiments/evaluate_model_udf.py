...
class LabelingQuality(UDFProposer):
    def __init__(
        self,
        config,
        object_domain,
    ...
    def _label_data_balanced(self, gt_udf_name, udf_description, n_obj):
        self.n_obj = n_obj
    ...
    def llm_annotate_data(self, batch_size=8):
...
if __name__ == "__main__":
    # python evaluate_model_udf.py --dataset "charades" --udf_name "holding" --llm_method "user" --n_train_distill 500 --balanced --run_id 0
    ...
    if balanced:
        up._label_data_balanced(udf_name, udf_description, n_obj)
