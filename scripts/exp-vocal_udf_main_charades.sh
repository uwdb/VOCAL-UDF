            ...
            for num_interpretations in 10; do
                ...
                for run in 0; do
                    ...
                    for query_id in {0..9}; do
                        sbatch exp-vocal_udf_main_charades.sbatch $query_id $run "charades" $query_class_name $budget $num_interpretations $num_missing_udfs
                    done
                done
            done
        done
