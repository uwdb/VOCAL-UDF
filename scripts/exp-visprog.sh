...
#                 sbatch exp-visprog.sbatch $num_missing_udfs $query_id $run "charades" $query_class_name
#             done
#         done
#     done
# done
...
#                 sbatch exp-visprog.sbatch $num_missing_udfs $query_id $run "cityflow" $query_class_name
#             done
#         done
#     done
# done